...
import {COMPANY_FACEBOOK_HANDLE_URL,BOOK_DEMO_URL, WHATSAPP_LIST_MESSAGE,WHATSAPP_CHAT_NUMBER , COMPANY_LINKEDIN_HANDLE_URL, COMPANY_INSTAGRAM_HANDLE_URL, COMPANY_YOUTUBE_HANDLE_URL, COMPANY_X_HANDLE_URL, COMPANY_DISCORD_HANDLE_URL, COMPANY_NAME, COMPANY_PHONE, COMPANY_EMAIL} from '../config/config'
