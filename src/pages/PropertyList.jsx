      ...
      <div className="container-xxl py-5" style={zoomStyle2} id='numbers'>
        <div className="container">
          ...
          <div className="row g-4 wow fadeInUp" data-wow-delay="0.02s" >
              ...
              <div className="col-lg-3 col-6 text-center mb-5" key={"occupancyRate"}>
                <IncrementTransitionWrapper >
                  <IncrementTansition2 className={"display-5 fw-bold text-primary mb-0"} n={stats?.performance?.occupancyRate?.value ?? 0} symbol1={``}  symbol2={stats?.performance?.occupancyRate?.suffix ?? ""}/>
                  </IncrementTransitionWrapper>
                <p className="text-muted mb-0 fw-medium">{stats?.performance?.occupancyRate?.label ?? ""}</p>
              </div>

              <div className="col-lg-3 col-6 text-center mb-5" key={"revenueGrowthYOY"}>
                <IncrementTransitionWrapper >
                  <IncrementTansition2 className={"display-5 fw-bold text-primary mb-0"} n={stats?.performance?.revenueGrowthYOY?.value ?? 0} symbol1={``}  symbol2={stats?.performance?.revenueGrowthYOY?.suffix ?? ""}/>
                  </IncrementTransitionWrapper>
                <p className="text-muted mb-0 fw-medium">{stats?.performance?.revenueGrowthYOY?.label ?? ""}</p>
              </div>

              <div className="col-lg-3 col-6 text-center mb-5" key={"noOfProperties"}>
                <IncrementTransitionWrapper >
                  <IncrementTansition2 className={"display-5 fw-bold text-primary mb-0"} n={stats?.performance?.noOfProperties?.value ?? 0} symbol1={``}  symbol2={stats?.performance?.noOfProperties?.suffix ?? ""}/>
                  </IncrementTransitionWrapper>
                <p className="text-muted mb-0 fw-medium">{stats?.performance?.noOfProperties?.label ?? ""}</p>
              </div>

              <div className="col-lg-3 col-6 text-center mb-5" key={"guestSatisfaction"}>
                <IncrementTransitionWrapper >
                  <IncrementTansition2 className={"display-5 fw-bold text-primary mb-0"} n={stats?.performance?.guestSatisfaction?.value ?? 0} symbol1={``}  symbol2={stats?.performance?.guestSatisfaction?.suffix ?? ""}/>
                  </IncrementTransitionWrapper>
